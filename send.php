...
$subject ="Новая заявка с сайта zhaluzy";
...
$header .= "From: Новая заявка <ultradan777@gmail.com>\n\n";  
$mail = mail("ultradan777@gmail.com", $subject1, iconv ('utf-8', 'windows-1251', $message1), iconv ('utf-8', 'windows-1251', $header));
